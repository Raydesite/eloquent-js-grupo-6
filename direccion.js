...
function direccion(texto) {
	let obj = [{ dir: 'ltr', c: 0 }, { dir: 'rtl', c: 0 }, { dir: 'ttb', c: 0 }];
	for (let letra of texto) {
		let d = codigoCaracter(letra.codePointAt());
		obj.forEach((a) => { if (a.dir == d) a.c++ });
	}
	return obj.sort((a, b) => b.c - a.c)[0].dir;
}
console.log(direccion('Hola!'));
// → ltr
console.log(direccion('Hey, مساء الخير'));
// → rtl
